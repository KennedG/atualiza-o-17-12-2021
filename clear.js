...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!message.member.permissions.has("MANAGE_MESSAGES")) return message.reply(`${message.author} **Você não possui permissão para esse comando.**`)
        ...
        try {
            ...
            .setColor("RED")
            .setDescription(`**\n📋 | Descrição: Utilize esse comando para limpar o chat.\n\n❓ | Como usar? Use da seguinte forma: g!clear (mensagens) \n\n📜 | Exemplo: g!clear 10**`)
